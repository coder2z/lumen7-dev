...
if (!function_exists('json_response')) {
     ...
     */
    function json_response($code, $msg, $data = null, $isEncrypt = false, $status = 200)
    {
        return response()->json(array('code' => $code, 'msg' => $msg, 'data' =>
            $data == null ?
                null :
                $isEncrypt ?
                    publicEncrypt($data) :
...
if (!function_exists('json_success')) {
    function json_success($msg = '操作成功!', $data = null, $isEncrypt = false, $code = 0, $StatusCode = 200)
    {
        return json_response($code, $msg, $data, $isEncrypt, $StatusCode);
    }
}
if (!function_exists('json_fail')) {
    function json_fail($msg = '操作失败!', $data = null, $isEncrypt = false, $code = 1, $StatusCode = 200)
    {
        return json_response($code, $msg, $data, $isEncrypt, $StatusCode);
    }
}
